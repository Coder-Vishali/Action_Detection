# python main_single_gpu.py DATA_PATH -m rgb -a rgb_resnet152 --new_length=1 --epochs 250 --lr 0.001 --lr_steps 100 200
# python main_single_gpu.py gms_frames -m rgb -a rgb_resnet152 --new_length=1 --epochs 250 --lr 0.001 --lr_steps 100 200 --iter-size 2 --print-freq 2 --save-freq 25 
# python main_single_gpu.py gms_frames -m flow -a flow_resnet152 --new_length=10 --epochs 350 --lr 0.001 --lr_steps 200 300 --iter-size 2 --print-freq 2 --save-freq 35 
...
parser.add_argument('data', metavar='DIR', default='./datasets/gms_frames',
...
parser.add_argument('--dataset', '-d', default='gms',
                    choices=["gms", "other"],
                    help='dataset: gms | other')
...
def main():
    ...
    print("\nData transforming mode : ", args.modality)
    # Data transforming
    ...
    print("\nDefine transformation of train and validate")
    ...
    train_dataset = datasets.__dict__[args.dataset].gms(root=args.data,
    ...
    val_dataset = datasets.__dict__[args.dataset].gms(root=args.data,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        # print("\ncalling adjust learning rate function")
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        # print("acc_mini_batch", acc_mini_batch)
        loss = criterion(output, target_var)
        loss = loss / args.iter_size
        loss_mini_batch += loss.data
        # print("loss_mini_batch", loss_mini_batch)
        loss.backward()
        # print("args.iter_size", args.iter_size)
        # print("i+1", i+1)
        # print("modulus operation:", (i+1) % args.iter_size)
        if (i+1) % args.iter_size == 0:
            ...
            # print("modulues operation of frequency ", (i+1) % args.print_freq) 
