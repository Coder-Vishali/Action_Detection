...
def main():
    ...
    spatial_net = models.rgb_resnet152(pretrained=False, num_classes=3)
    ...
    print("Total match found: ", match_count)
    print("Total videos: ", len(val_list))
    print("Accuracy is %4.4f" % (float(match_count)/len(val_list)))
    np.save("gms_s1_rgb_resnet152.npy", np.array(result_list))
